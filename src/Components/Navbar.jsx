...
export const Navbar = () => {
  ...
  return (
    <>
      <nav>
        <div className={`myContainer fixed-top ff_Outfit bg_primary ${open && `set_full mt-0 `} mob_nav py-2 rounded_5 ${ !open && `mt-4`} mt-md-4 `}>
          <div className="d-flex">
            <div className="w_header d-flex justify-content-center align-items-center">
              <ul className={`set_mob_nav ${open && `fix`}   d-md-flex justify-content-center align-items-center gap-5 text-white mb-0`}>
